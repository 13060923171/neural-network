...
if __name__ == '__main__':
    ...
    # img = Image.open(r"C:\Users\96075\Desktop\机器学习基础与实践\4.深度学习之卷积神经网络\人脸识别模型与验证\123.gif") # win要加绝对路径r避免报错。吐了
    #
    # print('读取成功！')
    # the data, shuffled and split between train and test sets
    (X_train, y_train), (X_val, y_val), (X_test,
                                        y_test) = load_data(r"C:\Users\96075\Desktop\机器学习基础与实践\4.深度学习之卷积神经网络\人脸识别模型与验证\123.gif")
    ...
    model.load_weights(r"C:\Users\96075\Desktop\机器学习基础与实践\4.深度学习之卷积神经网络\人脸识别模型与验证\facemodel_weights.h5") # 同样报错就改成这样的绝对路径
